...
if [ $PROTOC_EXISTS -eq 0 ]; then
	...
	echo "libprotoc 3.6.1 required, but found: $PROTOC_VERSION"
	exit 1
fi
...
if [ "$(uname)" == "Darwin" ]; then
    ...
    wget https://github.com/google/protobuf/releases/download/v3.6.1/protoc-3.6.1-linux-x86_64.zip -O /usr/local/src/protoc-3.6.1-linux-x86_64.zip
    unzip -x ../protoc-3.6.1-linux-x86_64.zip
